    ...
    return (
       <div className={styles.wrapper}>
            <Link to={"/"} className={styles.link}>
                <span data-text="Thanks" className={styles.textLink}>Reports</span>
                ...
                <div className={styles.inputWrapper}>
                    ...
                    <button className={styles.button}>Confirm</button>
                        ...
                        ? <div className={styles.tooltipContainment}>
                            <p className={styles.tooltipMainText}>Hello! To get started, enter the current balance of your account!</p>
                            <p className={styles.tooltipText}>You can't spend money until you have it :)</p>
                        </div>
                        : ''}
